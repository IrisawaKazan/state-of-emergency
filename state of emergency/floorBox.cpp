...
// コンストラクタ
//----------------------------------------
CFloorBox::CFloorBox(int nPriority) : CObject(nPriority)
{
	m_pTexture = nullptr;
	m_pMesh = nullptr;
	m_pBuffMat = nullptr;
...
// 生成処理
//----------------------------------------
CFloorBox* CFloorBox::Create(D3DXVECTOR3 pos)
{
	CFloorBox* pFloorBox;

	// 生成
	pFloorBox = new CFloorBox;

	// 初期化処理
	pFloorBox->Init();

	// 位置の設定
	pFloorBox->SetPosition(pos);
...
// 初期化処理
//----------------------------------------
HRESULT CFloorBox::Init(void)
{
	// 種類の設定処理
	CObject::SetType(TYPE_FLOORBOX);
...
// 位置の設定処理
//----------------------------------------
void CFloorBox::SetPosition(D3DXVECTOR3 pos)
{
	m_pos = pos;
}
...
// 前回の位置の設定処理
//----------------------------------------
void CFloorBox::SetPositionOld(D3DXVECTOR3 posOld)
{
	m_posOld = posOld;
}
...
// 向きの設定処理
//----------------------------------------
void CFloorBox::SetRotation(D3DXVECTOR3 rot)
{
	m_rot = rot;
}
...
// サイズの設定処理
//----------------------------------------
void CFloorBox::SetSize(D3DXVECTOR3 size)
{
	m_size = size;
}
...
// 位置の取得処理
//----------------------------------------
D3DXVECTOR3 CFloorBox::GetPos(void)
{
	return m_pos;
}
...
// 前回の位置の取得処理
//----------------------------------------
D3DXVECTOR3 CFloorBox::GetPosOld(void)
{
	return m_posOld;
}
...
// 向きの取得処理
//----------------------------------------
D3DXVECTOR3 CFloorBox::GetRot(void)
{
	return m_rot;
}
