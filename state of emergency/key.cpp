...
// コンストラクタ
//----------------------------------------
CKey::CKey(int nPriority) : CObject(nPriority)
{
	m_pTexture = nullptr;
	m_pMesh = nullptr;
	m_pBuffMat = nullptr;
...
// 生成処理
//----------------------------------------
CKey* CKey::Create(D3DXVECTOR3 pos)
{
	CKey* pKey;
...
// 位置の設定処理
//----------------------------------------
void CKey::SetPosition(D3DXVECTOR3 pos)
{
	m_pos = pos;
}
...
// 前回の位置の設定処理
//----------------------------------------
void CKey::SetPositionOld(D3DXVECTOR3 posOld)
{
	m_posOld = posOld;
}
...
// 向きの設定処理
//----------------------------------------
void CKey::SetRotation(D3DXVECTOR3 rot)
{
	m_rot = rot;
}
...
// サイズの設定処理
//----------------------------------------
void CKey::SetSize(D3DXVECTOR3 size)
{
	m_size = size;
}
...
// 前回の位置の取得処理
//----------------------------------------
D3DXVECTOR3 CKey::GetPosOld(void)
{
	return m_posOld;
}
